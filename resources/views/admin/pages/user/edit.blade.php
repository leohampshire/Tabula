                        ...
                        <div class="box-body">
                            <div class="form-group row">
                                <div class="col-xs-4 userType">
                                    ...
                                    <select name="user_type_id" class="form-control">
                                        ...
                                        <option @if($user->user_type_id == $userType->id) selected @endif
                            ...
                            <div class="form-group row">
                                <div class="col-xs-6">
                                    ...
                                    <input class="form-control" name="name" type="text" placeholder="Seu nome"
                                        value="{{ $user->name }}">
                                </div>

                                <div class="col-xs-6">
                                    <label for="birthdate">Data de Nascimento</label>
                                    <input class="form-control input-date" type="text" name="birthdate"
                                        placeholder="DD/MM/AAAA" value="{{ $user->birthdate }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="email">E-mail</label>
                                <input class="form-control" type="email" name="email" placeholder="exemplo@email.com"
                                    value="{{ $user->email }}">
                            </div>
                            <div class="sex form-group row">
                                <div class="col-xs-6">
                                    <label for="sex">Sexo: </label>
                                    <div class="form-group">
                                        <label class="radio-inline">
                                            <input @if($user->sex == 'Masculino') checked @endif type="radio" name="sex"
                                            value="Masculino">Masculino</label>
                                    </div>
                                    <div class="form-group">
                                        <label class="radio-inline"><input @if($user->sex == 'Feminino') checked @endif
                                            type="radio" name="sex" value="Feminino">Feminino</label>
                                    </div>
                                </div>
                                <div class="col-xs-6">
                            ...
                            <div class="form-group">
                                ...
                                <select id="schooling" name="schooling_id" class="form-control">
                                    ...
                                    <option value="{{ $schooling->id }}" @if($user->schooling_id == $schooling->id)
                                        selected @endif> {{ $schooling->name }} </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="5" id="bio" name="bio"
                                    placeholder="Escreva aqui...">{{ $user->bio }}</textarea>
                            </div>
                        </div>
