              ...
              <div class="box-body">
                <div class="form-group row">
                  <div class="col-xs-12">
                    ...
                    <select class="form-control" id="type_discount"  name="type_discount">
                      ...
                      <option value="porcentagem" @if($coupon->type_discount == 'porcentagem') selected @endif>Desconto Porcentagem</option>
                      <option value="dinheiro" @if($coupon->type_discount == 'dinheiro') selected @endif>Desconto  Monetário</option>
                    </select>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-xs-12">
                    ...
                    <select class="form-control" id="type_coupon" name="type_coupon">
                      <option selected disabled hidden>Escolha uma...</option>
                      <option value="carrinho" @if($coupon->type_coupon == 'carrinho') selected @endif>Desconto  fixo de carrinho</option>
                      <option value="produto" @if($coupon->type_coupon == 'produto') selected @endif>Desconto fixo de produto</option>
                      <option value="macrotema" @if($coupon->type_coupon == 'macrotema') selected @endif>Desconto fixo de Macrotema</option>
                      <option value="subcategoria" @if($coupon->type_coupon == 'subcategoria') selected @endif>Desconto fixo de SubCategoria</option>
                    </select>
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  <div class="col-xs-12">
                    ...
                    <input class="form-control" name="limit" type="number" placeholder="Limite (opcional)" value="{{ $coupon->limit }}">
                  </div>
                </div>     
