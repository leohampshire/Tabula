                            ...
                            <div class="form-group row">
                                <div class="col-xs-12">
                                    ...
                                    <select class="form-control" id="type_coupon" name="type_coupon">
                                        <option selected disabled hidden>Escolha uma...</option>
                                        <option value="carrinho" @if(old('type_coupon')=='carrinho' ) selected @endif>
                                            Desconto fixo de carrinho</option>
                                        <option value="produto" @if(old('type_coupon')=='produto' ) selected @endif>
                                            Desconto fixo de produto</option>
                                        <option value="macrotema" @if(old('type_coupon')=='macrotema' ) selected @endif>
                                            Desconto fixo de Macrotema</option>
                                        <option value="subcategoria" @if(old('type_coupon')=='subcategoria' ) selected
                                            @endif>Desconto fixo de SubCategoria</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <div class="col-xs-12">
                                    ...
                                    <input class="form-control" name="desc_coupon" type="text"
                                        placeholder="Descrição Cupom" value="{{ old('desc_coupon') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-xs-12">
                                    ...
                                    <input class="form-control" name="limit" type="number"
                                        placeholder="Limite (opcional)" value="{{ old('limit') }}">
                                </div>
                            </div>
