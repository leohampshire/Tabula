                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group row">
                                <div class="col-xs-12">
                                    ...
                                    <input type="text" name="urn" placeholder="URN" class="form-control input-urn" id="urn"
                                        value="{{old('urn')}}">
                                </div>
                            </div>
                            <div class="form-group  row">
                                <div class="col-xs-12">
                                    ...
                                    <input class="form-control" type="text" name="meta_title"
                                        placeholder="Definir Meta Title" value="{{ old('meta_title') }}">
                                </div>
                            </div>
                            <div class="form-group  row">
                                <div class="col-xs-12">
                            ...
                            <div class="form-group  row">
                                <div class="col-xs-12">
                                    ...
                                    <input class="form-control" type="text" name="keyword" placeholder="Definir KeyWord"
                                        value="{{ old('keyword') }}">
                                </div>
                            </div>
                        </div>
