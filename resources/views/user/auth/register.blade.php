            ...
            <div class="row form-group">
                <div class="col-sm-offset-4 col-sm-4">
                    ...
                    <label class="radio-inline">
                      <input type="radio" @if(old('sex') == 'Masculino') checked @endif name="sex" value="Masculino"> Masculino
                    </label>
                    <label class="radio-inline">
                      <input type="radio" @if(old('sex') == 'Feminino') checked @endif  name="sex" value="Feminino"> Feminino
                    </label>
                </div>
            </div>
