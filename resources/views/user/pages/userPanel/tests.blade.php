                            ...
                            <div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                                <input type="radio" name="alternative[{{$itm->id}}]" @if($answer->answer
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                                <input type="radio" name="true_false[{{$itm->id}}]" value="1" @if($answer->answer == '1') checked @endif disabled>
                                            </span>
                                            <p class="form-control">Verdadeiro</p>
                                        </div>
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                                <input type="radio" name="true_false[{{$itm->id}}]" value="0" @if($answer->answer == '0') checked @endif disabled>
                                            </span>
