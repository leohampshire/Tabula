              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('user.course.restart', ['id' => $student->id, 'course_id' => $course->id])}}" title="Reiniciar" class="act-list act-delete">
                        <i class="fa fa-refresh" aria-hidden="true"></i>
                      </a>
                      <a href="{{ route('user.course.student-certificate', ['id' => $student->id, 'course_id' => $course->id])}}" title="Gerar Certificado" class="act-list">
